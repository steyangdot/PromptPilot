...
from promptpilot.judges.slm import judge_via_max as _judge_via_max
...
def _gpt_pricing_for(model: str) -> tuple[float, float]:
    ...
    """
    from promptpilot.core.constants import MODEL_PRICING
...
class OpenAiJudge:
    ...
    def __init__(self, model: str | None = None):
        from promptpilot.core.constants import DEFAULT_SLM_OPENAI
