...
from promptpilot.core.constants import DEFAULT_LOG_FILE, DEFAULT_TARGET_MODEL, HELP_TEXT, MODEL_PRICING
from promptpilot.core.types import NormalizedRequest, TokenStats
from promptpilot.core.utils import maybe_log_run, write_stderr
from promptpilot.adapters.factory import AdapterFactory
...
from promptpilot.session import append_turn, clear_session, load_recent_turns, session_path_for
from promptpilot.stats import print_stats
from promptpilot.ui import print_review, print_token_stats
...
def parse_args(argv: Optional[Sequence[str]] = None) -> argparse.Namespace:
    ...
    parser = argparse.ArgumentParser(
        prog="promptpilot",
        description="Prompt-optimizing wrapper for AI coding CLIs",
...
def main(argv: Optional[Sequence[str]] = None) -> int:
    ...
    if args.subcommand == "checkpoint":
        from promptpilot.handoff import write_handoff
    ...
    if args.subcommand == "bootstrap":
        from promptpilot.handoff import read_handoff_into_session
        from pathlib import Path
        try:
    ...
    if args.subcommand == "restart":
        from promptpilot.handoff import restart_session
        from pathlib import Path
        try:
    ...
    if getattr(args, "compare", False):
        from promptpilot.ui import print_compare
