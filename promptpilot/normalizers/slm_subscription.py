...
from promptpilot.core.constants import DEFAULT_TARGET_MODEL, MODEL_PRICING
...
from promptpilot.judges.judge import Judge, get_default_judge
...
class SubscriptionSLMNormalizer(Normalizer):
    ...
    def __init__(
        ...
        if getattr(self._judge, "name", "") == "max":
            from promptpilot.judges.judge import warn_subscription_tos_once
