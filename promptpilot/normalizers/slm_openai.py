...
from promptpilot.core.constants import DEFAULT_SLM_OPENAI, DEFAULT_TARGET_MODEL, MODEL_PRICING
from promptpilot.core.types import NormalizedRequest, RepoMetadata, RewriteMode, TokenStats
from promptpilot.core.utils import write_stderr
from promptpilot.normalizers.base import Normalizer
from promptpilot.normalizers.heuristic import HeuristicNormalizer
from promptpilot.repo.loader import RepoContentLoader

# Reuse the same system prompts — they're model-agnostic
from promptpilot.normalizers.slm_anthropic import (
...
class OpenAISLMNormalizer(Normalizer):
    ...
    Requires: pip install promptpilot[codex]
    ...
    def __init__(self, api_key: Optional[str] = None, load_repo_content: bool = True) -> None:
        try:
            ...
            raise ImportError(
                ...
                "  Run: pip install promptpilot[codex]"
            )
    ...
    def is_referential(self, prompt: str) -> bool:
        ...
        """
        from promptpilot.normalizers.slm_anthropic import _SYSTEM_CLASSIFY_REFERENTIAL
        try:
            response = self._client.chat.completions.create(
                model=self.MODEL,
