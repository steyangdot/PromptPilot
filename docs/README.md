...
PromptPilot keeps repository docs intentionally small and uses the GitHub Wiki
for long-form product, workflow, and evaluation material.

## Use the GitHub Wiki for long-form docs
...
- [README.md](https://github.com/steyangdot/PromptPilot/blob/main/README.md) for project overview and install
